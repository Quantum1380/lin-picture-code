...
import com.linyu.linpicturebackend.model.vo.PictureTagCategory;
...
public class PictureController {
    ...
    public BaseResponse<String> testUploadFile(@RequestPart("file") MultipartFile multipartFile) {
        ...
        try {
            ...
            if (file != null) {
                ...
                if (!delete) {
                    System.out.println("file delete error, filepath = {}");
                }
            }
        }
    }
    ...
    public void testDownloadFile(String filepath, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            System.out.println("file download error, filepath = " + filepath + e);
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String cacheKey = String.format("linPicture:listPictureVOByPageWithCache:%s", hashKey);
        // 从本地缓存中查询
